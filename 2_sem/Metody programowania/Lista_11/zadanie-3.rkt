...
(define (let*-desug [vs : (Listof (Symbol * Exp))] [e : Exp])
  (if (empty? (rest vs)) (let*E (fst (first vs)) (snd (first vs)) e)
      (let*E (fst (first vs)) (snd (first vs)) (let*-desug (rest vs) e))))
