...
(define (evalA [a : ExpA] [env : (EnvA Value)]) : Value
  (type-case ExpA a
    ...
    [(lamA a) (funVA a env)]
    [(appA a1 a2) (applyA (evalA a1 env) (evalA a2 env))]))
...
;Indeksy de Bruijna dobrze współgrają z domknięciami,
;ponieważ umożliwiają jasne odniesienia do zmiennych
;zdefiniowanych w środowisku, w którym funkcja była pierwotnie zdefiniowana