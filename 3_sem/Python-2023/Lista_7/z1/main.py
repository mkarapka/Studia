...
def crawl(start_page, distance, action):
    ...
    def process_page(url, step):
        ...
        def put_to_queue(page, step):
            result = process_page(page, step)
        ...
        if url not in visited:
            ...
            try:
                ...
                results_queue = Queue()
                next_pages = [
                    Thread(target=put_to_queue, args=(link.get("href"), step + 1))
...
print_result(host, 2, lambda tekst: return_senteces(tekst, "Python"))
